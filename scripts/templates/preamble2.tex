...
\@ifclasswith\class{nocolor}{
    ...
    \createnewcoloredtheoremstyle{thmpropertiesbox}{example_color}{}{}
    \createnewcoloredtheoremstyle{thmnotationbox}{example_color}{}{}
...
\declaretheorem[sibling=definition, style=thmcorollarybox,   name=Corollary]{corollary}
\declaretheorem[sibling=definition, style=thmpropbox,        name=Proposition]{proposition}
\declaretheorem[sibling=definition, style=thmlemmabox,       name=Lemma]{lemma}
\declaretheorem[numberwithin=section, style=thmexercisebox,    name=Exercise]{exercise}
\declaretheorem[numbered=no,          style=thmproofbox,       name=Proof]{proof0}
\declaretheorem[numbered=no,          style=thmpropertiesbox,       name=Properties]{properties}
